...
>>>>>>> 643a8e04c1062d93e192c7106d158ab5e0140f80
    ...
    <div class="modal fade" id="addJobModal" tabindex="-1" aria-labelledby="addJobModalLabel" aria-hidden="true" data-bs-backdrop="static">
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
<<<<<<< HEAD
                <form method="POST" action="{{ route('job_vacancies.store') }}" id="addJobForm">
                    @csrf
...
<<<<<<< HEAD
    ...
    form.addEventListener('submit', function(e) {
        ...
        if (!form.querySelector('[name="date_posted"]').value) {
            form.querySelector('[name="date_posted"]').value = new Date().toISOString().split('T')[0];
        }
