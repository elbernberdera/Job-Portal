...
@section('page_title', 'Create New Job Position')
...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0 text-dark">Create New Job Position</h1>
            </div>
            <div class="col-sm-6">
    ...
    <div class="container-fluid">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">Job Position Details</h3>
            </div>
            <form action="{{ route('admin.job_positions.store') }}" method="POST">
                @csrf
                <div class="card-body">
                    @if($errors->any())
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('position_code') is-invalid @enderror" 
                                       id="position_code" name="position_code" value="{{ old('position_code') }}" required>
                                @error('position_code')
                                    <span class="invalid-feedback">{{ $message }}</span>
                                @enderror
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control @error('division') is-invalid @enderror" id="division" name="division" required>
                                    ...
                                    <option value="Admin and Finance" {{ old('division') == 'Admin and Finance' ? 'selected' : '' }}>Admin and Finance</option>
                                    <option value="Technical Operations Division" {{ old('division') == 'Technical Operations Division' ? 'selected' : '' }}>Technical Operations Division</option>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control @error('region') is-invalid @enderror" id="region" name="region" required>
                                    ...
                                    <option value="Region IV-B" {{ old('region') == 'Region IV-B' ? 'selected' : '' }}>Region IV-B</option>
                                    ...
                                    <option value="CARAGA" {{ old('region') == 'CARAGA' ? 'selected' : '' }}>CARAGA</option>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control @error('date_posted') is-invalid @enderror" 
                                       id="date_posted" name="date_posted" value="{{ old('date_posted', date('Y-m-d')) }}">
                                @error('date_posted')
                                    <span class="invalid-feedback">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control @error('eligibility') is-invalid @enderror" 
                                          id="eligibility" name="eligibility" rows="3">{{ old('eligibility') }}</textarea>
                                @error('eligibility')
                                    <span class="invalid-feedback">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select class="form-control @error('min_education_level') is-invalid @enderror" id="min_education_level" name="min_education_level">
                                    ...
                                    <option value="Elementary" {{ old('min_education_level') == 'Elementary' ? 'selected' : '' }}>Elementary</option>
                                    <option value="High School" {{ old('min_education_level') == 'High School' ? 'selected' : '' }}>High School</option>
                                    <option value="Vocational" {{ old('min_education_level') == 'Vocational' ? 'selected' : '' }}>Vocational</option>
                                    <option value="Bachelor's Degree" {{ old('min_education_level') == 'Bachelor\'s Degree' ? 'selected' : '' }}>Bachelor's Degree</option>
                                    <option value="Master's Degree" {{ old('min_education_level') == 'Master\'s Degree' ? 'selected' : '' }}>Master's Degree</option>
                                    <option value="Doctorate" {{ old('min_education_level') == 'Doctorate' ? 'selected' : '' }}>Doctorate</option>
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" min="0" class="form-control @error('min_years_experience') is-invalid @enderror" 
                                       id="min_years_experience" name="min_years_experience" value="{{ old('min_years_experience') }}">
                ...
                <div class="card-footer">
                    <button type="submit" class="btn btn-primary">
                        <i class="fas fa-save"></i> Create Job Position
                    </button>
