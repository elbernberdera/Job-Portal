    ...
    <div class="sidebar" style="color: #000!important;">
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                <li class="nav-item">
              <a href="{{ route('admin.dashboard') }}" class="nav-link {% if request.resolver_match.url_name == '' %}bg-success text-white{% endif %}" style="color: #fdfafa!important;">
                <i class="nav-icon fas fa-home" style="color: #fbf8f8!important;"></i>
                <p>Home</p>
              </a>
            </li>
            <li class="nav-item">
              <a href="{{ route('admin.logs') }}" class="nav-link {% if request.resolver_match.url_name == '' %}bg-success text-white{% endif %}" style="color: #fdfafa!important;">
            ...
            <li class="nav-item">
              <a href="{{ route('admin.accounts') }}" class="nav-link {% if request.resolver_match.url_name == '' %}bg-success text-white{% endif %}" style="color: #fdfafa!important;">
                <i class="nav-icon fas fa-users" style="color: #fbf8f8!important;"></i>
                <p>User</p>
              </a>
            </li>
