...
<script defer src="{{ asset('assets/assets/js/bootstrap.min.js') }}"></script>
<script defer src="{{ asset('assets/assets/js/script.js') }}"></script>
              ...
              <div class="c1-container-body">
                ...
                <div class="holder-box-0">
                  <div class="form-group row">
                    ...
                    <div class="col-sm-4">
                      <input type="text" class="form-control" id="CSID" placeholder="CSID">
                    </div>
                  </div>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-5 d-flex align-items-center">
                      <div class="form-check me-4">
                        ...
                        <label class="form-check-label" for="TDYes">Yes</label>
                      </div>
  ...
  <div class="form-check me-4">
    ...
    <label class="form-check-label" for="FDYes">Yes</label>
  </div>

  <div class="form-check">
    <input class="form-check-input" type="radio" name="FD" id="FDNo" value="No">
    <label class="form-check-label" for="FDNo">No</label>
  </div>
</div>
                  ...
                  <div class="col-sm-5">
                      ...
                      <div class="d-flex align-items-center mb-3">
                        <div class="form-check me-4">
                          ...
                          <label class="form-check-label" for="AOYes">Yes</label>
                        </div>

                        <div class="form-check">
                          <input class="form-check-input" type="radio" name="AO" id="AONo" value="No">
                          <label class="form-check-label" for="AONo">No</label>
                        </div>
                      </div>

                      <label for="AODetails" class="form-label">If YES, give details:</label>
                  ...
                  <div class="col-sm-5">
                        ...
                        <div class="d-flex align-items-center mb-3">
                          <div class="form-check me-4">
                            ...
                            <label class="form-check-label" for="CCYes">Yes</label>
                          </div>

                          <div class="form-check">
                            <input class="form-check-input" type="radio" name="CC" id="CCNo" value="No">
                            <label class="form-check-label" for="CCNo">No</label>
                          </div>
                        </div>

                        <!-- Label for details -->
                        <label for="CCDate" class="form-label mb-2">If YES, give details:</label>

                        <!-- Date Filed -->
                        <div class="form-group row mb-3">
                          <label for="CCDate" class="col-sm-4 col-form-label">Date Filed:</label>
                          <div class="col-sm-8">
                            <input type="date" class="form-control" id="CCDate" placeholder="Date Filed">
                          </div>
                        </div>

                        <!-- Status of Case/s -->
                        <div class="form-group row">
                          <label for="CCSOC" class="col-sm-4 col-form-label">Status of Case/s:</label>
                          <div class="col-sm-8">
                            <input type="text" class="form-control" id="CCSOC" placeholder="Status of Case/s">
                          </div>
                        </div>
                      </div>
                      ...
                      <!-- Radio buttons -->
                        <div class="d-flex align-items-center mb-3">
                          <div class="form-check me-4">
                            ...
                            <label class="form-check-label" for="CoVYes">Yes</label>
                          </div>

                          <div class="form-check">
                            <input class="form-check-input" type="radio" name="CoV" id="CoVNo" value="No">
                            <label class="form-check-label" for="CoVNo">No</label>
                          </div>
                        </div>


                      <!-- Details textarea -->
                      <label for="CoVDetails" class="form-label">If YES, give details:</label>
                  ...
                  <div class="col-sm-5">
                        ...
                        <div class="d-flex align-items-center mb-3">
                          <div class="form-check me-4">
                            ...
                            <label class="form-check-label" for="SFTSYes">Yes</label>
                          </div>

                          <div class="form-check">
                            <input class="form-check-input" type="radio" name="SFTS" id="SFTSNo" value="No">
                            <label class="form-check-label" for="SFTSNo">No</label>
                          </div>
                        </div>

                        <!-- Details textarea -->
                        <label for="SFTSDetails" class="form-label">If YES, give details:</label>
                  ...
                  <div class="col-sm-5">
                      ...
                      <div class="d-flex align-items-center mb-3">
                        <div class="form-check me-4">
                          ...
                          <label class="form-check-label" for="CNOLEYes">Yes</label>
                        </div>

                        <div class="form-check">
                          <input class="form-check-input" type="radio" name="CNOLE" id="CNOLENo" value="No">
                          <label class="form-check-label" for="CNOLENo">No</label>
                        </div>
                      </div>

                      <!-- Details textarea -->
                      <label for="CNOLEDetails" class="form-label">If YES, give details:</label>
...
<textarea class="form-control" id="CNOLEDetails" rows="3"></textarea>
  ...
  <div class="d-flex align-items-center mb-3">
    <div class="form-check me-4">
      ...
      <label class="form-check-label" for="IGYes">Yes</label>
    </div>

    <div class="form-check">
      <input class="form-check-input" type="radio" name="IG" id="IGNo" value="No">
      <label class="form-check-label" for="IGNo">No</label>
    </div>
  </div>

  <!-- Details input -->
  <div class="form-group row">
    <label for="IGDetails" class="col-sm-4 col-form-label">If Yes, please specify:</label>
    <div class="col-sm-8">
  ...
  <!-- Details input -->
  <div class="form-group row">
    <label for="IGDetails" class="col-sm-4 col-form-label">If Yes, please specify ID No::</label>
    <div class="col-sm-8">
      <input type="text" class="form-control" id="IGDetails" placeholder="IGDetails">
    </div>
  </div>
...
@endpush
>>>>>>> 643a8e04c1062d93e192c7106d158ab5e0140f80
